...
def calcolaFOV_Grasp(rootdir,resdir,fileLista,enTarget,requirements,spiderFactor,Wfactor,areaCopyFlag,
    ...
    for config in a:
        ...
        #enTarget=ener[:]
        aree=extractInfo.loadCol(os.path.join(config,"aree.txt"),1)[0] #recupera vettore delle aree in asse
        m=max(aree)
...
if __name__=="__main__":
    rootdir=r"C:\work2\traie6\simx2008_ufficiale"#"C:\work\copiaOA\batch\batch5\simX2007"
    resdir="FOV"
    enTarget=30.
    fileLista='lista.txt'    
    spiderFactor=0.9
