import os
import string
#copiata da G:\vince\prog\offaxis\OA\simX2006\generalRoutines.py
...
def recuperaPeso(dir,enerTarget=""):
    ...
    ff=open(os.path.join(baseDirW,"pesi2.txt"),"r")
